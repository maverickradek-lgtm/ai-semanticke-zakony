...
def migrate_one_document(conn, doc):
    ...
    ZMENA 2026-08-29 #5 (chyba zjistena Radkem - "Zakon obcansky zakonik"
    mel v Neonu jen 1000 z 3000 chunku): puvodne jeden sb_get() s limit=2000 -
    Supabase/PostgREST vychozi max-rows (1000) tise orizne odpoved bez ohledu
    na pozadovany limit, takze u velkych dokumentu (>1000 chunku) se
    zkopirovala jen prvni tisicovka. Ted se strankuje stejne jako jinde
    v tomto skriptu (limit/offset cyklus), dokud API nevrati mene nez
    velikost stranky."""
