...
function issuerLabel(series: string | null): string {
  if (series === "pokyny_d") return "Finanční správa (Pokyny D)";
  if (series === "pokyny_mf") return "Finanční správa (Pokyny MF)";
  return "Finanční správa";
}
